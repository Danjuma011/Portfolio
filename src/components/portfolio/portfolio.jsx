...
import streetFood from "../../assets/thestreetfood.png";
    ...
    <section id="portfolio">
      ...
      <div className="container portfolio__container">
        <article className="portfolio__item">
          ...
          <div className="portfolio__item-cta flex justify-around">
            <a
              href="https://github.com/rash1234567/NEWVIVIDIO"
              className="btn"
              target="_blank"
            >
              Github
            ...
            <a
              href="https://vividioz.onrender.com/"
        ...
        <article className="portfolio__item">
          ...
          <div className="portfolio__item-cta flex justify-around">
            <a
              href="https://github.com/Danjuma011/AstroHome"
              className="btn"
              target="_blank"
            >
              Github
            ...
            <a
              href="https://astrohome.netlify.app"
              className="btn btn-primary"
              target="_blank"
            >
              Live Demo
        ...
        <article className="portfolio__item">
          ...
          <div className="portfolio__item-cta flex justify-around">
            <a
              href="https://github.com/Lawdshev/Frontend.git"
              className="btn"
              target="_blank"
            >
              Github
      ...
      <div className="w-full flex mt-2">
        ...
        <Link to="/projects" className="mx-auto text-xl md:text-2xl">
          See more frontend projects <i class="fa-solid fa-right-long"></i>
        </Link>
      </div>
      <div className="container portfolio__container">
